...
class RobotController(Node):
    def __init__(self):
        ...
        self.get_logger().info("🤖 Robot Control V3 Ready (Pick & Lift Mode)")
        self.init_robot()
    ...
    def execute_move(self, msg, action="show"):
        ...
        # # 4. 준비 자세 이동
        # JReady = [0.0, 0.0, 90.0, 0.0, 90.0, 0.0]
        # self.get_logger().info("🛫 Moving to JReady...")
        ...
        if action == "show":
            ...
            gripper.close_gripper() # 이동 중 안전을 위해 닫음 (선택사항)
